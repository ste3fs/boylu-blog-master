<template>
  <aside class="sidebar">
    <el-card class="author-card">
      ...
      <div class="card-header">
        <div class="author-avatar">
          <el-avatar class="avatar" :src="authorAvatarSrc" alt="作者头像" />
        </div>
    ...
    <SignalPanel :category-count="categoryCount" :sidebar-mode="true" />
...
export default {
  ...
  computed: {
    authorAvatarSrc() {
      return this.resolveImage(this.$store.state.webSiteInfo.authorAvatar || '/boylu-avatar.jpg')
    },
    socialLinksWithData() {
