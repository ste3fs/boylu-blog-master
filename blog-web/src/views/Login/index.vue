      ...
      <div class="login-body">
        ...
        <div v-show="currentForm === 'login'" class="form-container">
          <div class="qrcode-content">
            ...
            <ul class="wechat-guide">
              <li>第 1 步：微信扫码关注你的公众号。</li>
              <li>第 2 步：向公众号发送上面的 <strong>DL 登录码</strong>。</li>
              <li>第 3 步：页面会自动完成登录，不需要手动刷新。</li>
            </ul>
            <div class="wechat-helper">
              <span>公众号相关微信号：{{ $store.state.webSiteInfo.wechat || "待配置" }}</span>
              <button type="button" class="mini-copy-btn" @click="copyWechatHandle">
                复制微信号
              </button>
            </div>
          </div>
