  ...
  <div class="navbar-container">
    <div class="custom-dropdown" v-click-outside="closeDropdown">
      ...
      <transition v-if="isMobile" name="fade">
        <div v-show="isOpen" class="mobile-user-mask" @click="closeDropdown"></div>
      </transition>

      <transition name="dropdown">
        <div v-show="isOpen" class="dropdown-menu" :class="{ 'dropdown-menu--mobile': isMobile }">
          <div class="user-info">
          ...
          <div class="menu-items">
            <div class="menu-item" @click="toGitee">
              ...
              <div class="menu-content">
                ...
                <span class="menu-desc">查看后台项目源码</span>
              </div>
            </div>
            ...
            <div class="menu-item" @click="toProfile">
              ...
              <div class="menu-content">
                ...
                <span class="menu-desc">管理当前账号资料</span>
              </div>
            </div>
            ...
            <div class="menu-item" @click="handleLock">
              ...
              <div class="menu-content">
                ...
                <span class="menu-desc">临时锁屏，保护后台内容</span>
              </div>
            </div>
...
import { CaretBottom, Document, Lock, SwitchButton, User } from '@element-plus/icons-vue'
...
const avatarSrc = computed(() => {
  ...
  const normalizedAvatar = /^https?:\/\//i.test(avatar)
    ? avatar
    : avatar.startsWith('/')
      ? avatar
      : `/${avatar}`

  return `${normalizedAvatar}${normalizedAvatar.includes('?') ? '&' : '?'}v=${avatarVersion}`
})

const displayName = computed(() => userStore.user.nickname || userStore.user.username || 'boylu')
