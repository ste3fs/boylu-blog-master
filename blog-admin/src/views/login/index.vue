  ...
  <div class="login-container" :class="{ dark: isDark }">
    ...
    <div class="login-form">
      <div class="form-wrapper">
        ...
        <!-- 登录方式切换 -->
        <div v-if="enableQrLogin" class="login-tabs">
          <div
            class="tab-item"
        ...
        <transition name="fade-transform" mode="out-in">
          <el-form
            v-if="!enableQrLogin || loginType === 'account'"
            ref="loginFormRef"
            :model="loginForm"
            :rules="rules"
...
const enableQrLogin = false;
const enableSocialLogin = false;
const loginType = ref("account");
const qrCodeUrl = ref(new URL("../../assets/scan-placeholder.svg", import.meta.url).href);
