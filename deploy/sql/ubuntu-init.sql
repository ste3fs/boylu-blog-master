...
UPDATE sys_article
SET content = REPLACE(content, 'http://127.0.0.1:8800/localFile/', '/localFile/'),
    content_md = REPLACE(content_md, 'http://127.0.0.1:8800/localFile/', '/localFile/');
